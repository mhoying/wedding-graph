  ...
  return (
    <header className="glass-panel top-bar no-print">
      ...
      <div className="header-controls-grid" style={{ display: 'flex', flexDirection: 'column', gap: 6, flex: 1, minWidth: 0 }}>
        ...
        <div className="header-controls-row top-row" style={{ display: 'flex', alignItems: 'center', gap: 8, width: '100%', flexWrap: 'nowrap' }}>
          ...
          >
            ...
            <input 
              ...
              style={{ width: '100%', minWidth: 0, background: 'transparent', border: 'none', color: '#ffffff', fontSize: 13, fontWeight: 700, outline: 'none' }}
            />
            {searchQuery && (
              <button 
                type="button" 
                onClick={() => setSearchQuery('')}
                style={{ background: 'none', border: 'none', color: '#94a3b8', cursor: 'pointer', padding: 2, display: 'flex', alignItems: 'center', flexShrink: 0 }}
                title="Clear Search"
              >
        ...
        {/* ACTIVE FILTER CHIPS SECTION (Dedicated Full-Width Wrap Row) */}
        {hasActiveFilters && (
          <div 
